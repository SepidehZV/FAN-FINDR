      ...
      <div className="card" >
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <textarea type="text" className="form-control" laceholder="item_description" value={item_description} onChange={(e) => setItem_description(e.target.value)}  />
          </div>
        </div>
        <div className="col-md-6">
          <div className="form-group">
        ...
        <div className="card-body">
          <div className="edit-and-delete" >
              <div className="save" onClick={() => {props.onSave(props.id, item_name, price, item_description,props.venue_id);props.transition("SHOW")}} ><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-check-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
