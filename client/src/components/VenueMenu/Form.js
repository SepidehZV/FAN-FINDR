      ...
      <div className="card" >
        ...
        <div className="card-body">
          <div className="edit-and-delete" >
            ...
            <div className="edit-and-delete">
              <div className="save" onClick={validate}><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
