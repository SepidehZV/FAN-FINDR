...
<div className="col">
<h1><button type="button" className="btn  btn-save-patron " onClick={props.onEdit} ><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
