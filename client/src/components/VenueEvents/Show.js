...
export default function Show(props) {
  ...
  <div className="info-and-fav" >
          ...
          <div className="edit-and-delete">
              <div className="delete" onClick={props.deleteMenu}><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
